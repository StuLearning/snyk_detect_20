module github.com/openshift/elasticsearch-operator-v0.0.0-20220524192433-5be78f98afc2

go 1.17

require github.com/openshift/elasticsearch-operator v0.0.0-20220524192433-5be78f98afc2
