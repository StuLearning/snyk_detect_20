module github.com/openshift/elasticsearch-operator-v0.0.0-20220510141603-65a736a07be1

go 1.17

require github.com/openshift/elasticsearch-operator v0.0.0-20220510141603-65a736a07be1
