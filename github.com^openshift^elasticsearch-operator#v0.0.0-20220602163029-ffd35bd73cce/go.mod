module github.com/openshift/elasticsearch-operator-v0.0.0-20220602163029-ffd35bd73cce

go 1.17

require github.com/openshift/elasticsearch-operator v0.0.0-20220602163029-ffd35bd73cce
