module github.com/openshift/elasticsearch-operator-v0.0.0-20220607135227-4278ce1a6f3e

go 1.17

require github.com/openshift/elasticsearch-operator v0.0.0-20220607135227-4278ce1a6f3e
